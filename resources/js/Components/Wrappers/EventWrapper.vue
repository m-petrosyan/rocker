    ...
    <div class="relative">
        ...
        >
            ...
            >
                ...
                <div class="group relative block h-full min-h-[430px] overflow-hidden rounded-lg border border-white/10 bg-[#050505] shadow-[0_18px_45px_rgba(0,0,0,0.45)] transition duration-300 hover:-translate-y-1 hover:border-orange/70 hover:shadow-[0_22px_60px_rgba(255,87,34,0.16)]">
                    <NavLink
                        :href="
                            route(
                    ...
                    <div
                        ...
                        class="absolute bottom-2 left-2 right-2 z-50 flex items-center justify-between rounded-lg bg-black/75 px-3 py-2 backdrop-blur-sm"
                        @click.stop
                    >
                        <NavLink
                            tooltip="Edit"
                            :href="route('profile.events.edit', event.id)"
                            class="rounded bg-white/15 p-1.5 hover:bg-white/25"
                        >
                            <EditIcon />
                        </NavLink>
                        <button
                            ...
                            class="rounded bg-white/15 p-1.5 text-red-500 hover:bg-white/25 hover:text-red-400"
                        >
                            <DeleteIcon />
                        </button>
                    </div>
