    ...
    <ProfileLayout :meta="{ title: 'Band create' }">
        <div>
            ...
            >
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex w-full flex-col gap-2 md:flex-row">
                        <Preview
                            ...
                            classes="bg-contain"
                            class="min-h-96 w-full md:w-1/2"
                            labelClass="h-full"
                        ...
                        <div class="flex w-full flex-col gap-2 md:w-1/2">
                            ...
                            <div class="text-gray">
                                <b>Note :</b>
                                <p class="text-orange">
                                    A mandatory requirement for adding a band is
                                    that it must have performed concerts.
                                </p>
                                <div class="flex gap-5">
                                    <p>
                                        You can also add a video from youtube by
                                        clicking the button
                                    </p>
                                    <img
                                        src="/images/video_instruction.png"
                                        alt="instruction"
                                    />
                                </div>
                                <p>
                                    Tell us a bit about your band! When did you
                                    start? Who's in the lineup? Just a few words
                                    about your story, vibe, and members will
                                    make your profile way cooler. And if you
                                    have any albums, don’t forget to list them
                                    below – it’s a brand-new feature we’ve just
                                    added! 🎶
                                </p>
                                <p>
                ...
                <h3 class="mt-4 text-center text-gray">Albums</h3>
                <BandAlbums v-model:albums="form.albums" canEdit />
                <br />
                <PrimaryButton
                    class="ms-4"
