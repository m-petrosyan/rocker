...
<template>
    <GuestLayout
        :meta="{title: gallery.title+' – Armenian Rock/Metal Music, Concerts & Albums' ,image:gallery.cover_img.large , description, author:gallery.user.name,keywords: gallery.bands.map(band => band.name).join(',')}">
        <h1>{{ gallery.title }}</h1>
